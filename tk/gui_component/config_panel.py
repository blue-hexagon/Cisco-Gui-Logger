...
class Checkbox:
    ...
    def __init__(self, parent, statusbar, elem_text, statusbar_text, col, row):
        self.var = BooleanVar()
...
class ConfigPanel:
    def __init__(self, config_panel, statusbar):
        ...
        self.spanning_tree = Checkbox(self.config_checkboxes2, statusbar, "Spanning Tree", "Retrieve details about STP", 0, 5)
